...
defaultOutputPath = "/Users/lfxjtu/OneDrive - Whitireia and WelTec/SSD/left_barriers/Low_Detections_C0.5/"
image_name_pre = "img_"
...
workbook = xlsxwriter.Workbook('Default_Detection_Experiment_C0.5_Low.xlsx')
...
for j in range(1, 401):
    ...
    (h, w) = image.shape[:2]
    blob = cv2.dnn.blobFromImage(cv2.resize(image, (100, 100)), 0.007843, (100, 100), 127.5)
    ...
    for i in np.arange(0, detections.shape[2]):
        ...
        if confidence > test_confidence:
            ...
            worksheet.write(j-1, idx, confidence*100)
