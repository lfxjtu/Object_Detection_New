...
defaultOutputPath = "/Users/lfxjtu/OneDrive - Whitireia and WelTec/SSD/left_barriers/High_Detections_C0.2/"
image_name_pre = "img_"
...
workbook = xlsxwriter.Workbook('High_Detection_Experiment_C0.2.xlsx')
...
for j in range(1, 401):
    ...
    (h, w) = image.shape[:2]
    blob = cv2.dnn.blobFromImage(cv2.resize(image, (640, 480)), 0.007843, (640, 480), 127.5)
