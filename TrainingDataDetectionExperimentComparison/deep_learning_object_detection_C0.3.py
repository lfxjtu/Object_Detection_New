...
defaultOutputPath = "/Users/lfxjtu/OneDrive - Whitireia and WelTec/SSD/left_barriers/GTDetections_C0.3/"
image_name_pre = "img_"
...
workbook = xlsxwriter.Workbook('GroundTruth_Detection_Experiment_C0.3.xlsx')
workbook2 = xlsxwriter.Workbook('TrainingData.xlsx')
# The workbook object is then used to add new
# worksheet via the add_worksheet() method.
worksheet = workbook.add_worksheet()
worksheet2 = workbook2.add_worksheet()
# Use the worksheet object to write CLASSES via the write() method.
# m = 0
# for m in range(20):
#     worksheet.write(0, m, CLASSES[m])
...
while j < 401:
    ...
    for i in np.arange(0, detections.shape[2]):
        ...
        if confidence > test_confidence:
            ...
            if idx == 7:
                cv2.waitKey(0)
                detected_car_count = detected_car_count + 1
            ...
            # record the confidence of the car to the worksheet:

        worksheet.write(j-1, 1, detected_car_count)
        worksheet2.write((j-1)/5, 1, image_name)
