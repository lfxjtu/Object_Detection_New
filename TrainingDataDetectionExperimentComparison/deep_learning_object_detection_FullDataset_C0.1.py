...
defaultOutputPath = "/Users/lfxjtu/OneDrive - Whitireia and WelTec/SSD/left_barriers/DefaultDetections_C0.1/"
image_name_pre = "img_"
...
workbook = xlsxwriter.Workbook('GroundTruth_Detection_FullDataset_C0.1.xlsx')
...
m = 0
for m in range(20):
    worksheet2.write(0, m, CLASSES[m])
